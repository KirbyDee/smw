...
org $06F624
	autoclean dl acts_likes_1;read3($06F624)		; > Table containing all the acts like of the blocks in range 0000-3FFF
...
if !__insert_pages_40_plus == 1
	...
	org $06F63A
		dl acts_likes_2-$8000
	; > Table containing all the acts like of the blocks in range 4000-7FFF
	freedata cleaned
acts_likes_2:
