...
MarioBelowBottom:
	...
	AND.b #%00001111		;|
	BEQ enterBottom			;/then enter
	CMP #$03			;\if going down..
	BEQ exitBottom			;|then exit
	CMP #$07			;|
	BEQ exitBottom			;/
	BRA within_pipe_bottom		;>other directions = pass
enterBottom:
	LDA $187A|!addr		;>no yoshi.
	ORA $19			;>no powerup
	BNE returnBottom	;>otherwise return
...
BodyInsideBottom:
	...
	AND.b #%00001111		;|
	BEQ returnBottom		;/when not in pipe
	CMP #$03			;\exit of going down
	BEQ exitBottom			;|
	CMP #$07			;|
	BEQ exitBottom			;/
	BRA within_pipe_bottom
exitBottom:
