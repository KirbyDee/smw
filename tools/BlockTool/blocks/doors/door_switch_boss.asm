...
if !Reversed
	print "The bottom part of a boss door which you can only enter if a specific switch isn't active."
else
	print "The bottom part of a boss door which you can only enter if a specific switch is active."
endif
