...
!BanzaiGFX1 	=	$C8	;tile of the upper left part of the sprite. It's also used for the bottom part.
!BanzaiGFX2	=	$8C	;tile of the almost upper left part of the sprite. It's also used for the bottom part.
!BanzaiGFX3	=	$E8	;tile of the almost upper left part of the sprite. It's also used for the bottom part.
!BanzaiGFX4	= 	$EA	;tile of the upper right part of the sprite. It's also used for the bottom part.
!BanzaiGFX5	=	$84	;tile of one of the 1st eye part of the sprite.
!BanzaiGFX6	=	$86	;tile of the 2nd eye part of the sprite.
!BanzaiGFX7	=	$C0	;tile of one of the connector parts of the sprite. It's also used below.
!BanzaiGFX8	=	$E0	;tile of the other connector part of the sprite. It's also used below.
!BanzaiGFX9	=	$C4	;tile of the first part of the GFX file of the sprite's mouth.
!BanzaiGFX10	=	$C6	;tile of the 2nd part of the GFX file of the sprite's mouth.
!BanzaiGFX11	=	$8A	;tile of the 3rd part of the GFX file of the sprite's mouth.
!BanzaiGFX12	=	$AA	;tile of the last part of the GFX file of the sprite's mouth.

!BanzaiPal1	=	$3B	;uses palette 3 on 2nd GFX page. For the 1st palette and GFX page 1, set to $30.
!BanzaiPal2	=	$BB	;uses palette 3 on 2nd GFX page. For the 1st palette and GFX page 1, set to $B0.
