...
!reversed		= $30		; The reversed gravity flag.
!GTAddr 		= $18C7		; Timer for switch gravity
!GravTimer 		= $10		; Amount of frames it takes for the gravity switch to work again
...
flip_gravity:	
	...
	+	STA $96
		...
		LDA #!GravTimer		;load amount of frames
		STA !GTAddr		;store to decrementer.
